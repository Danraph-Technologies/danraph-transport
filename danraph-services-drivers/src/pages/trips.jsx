  ...
  return (
    <div>
     <div className='max-w-[510px] relative w-full border border-gray-300 rounded-lg px-4 lg:mx-5 py-4'>
      ...
      <div >
        <p className='sm:text-[26px] text-[22px] font-semibold py-1 pb-3 pt-3 my-3'>Past Trips</p>
         
        <div   ref={pastTripsRef} className='max-h-[80vh] overflow-auto hide-scrollbar-sm'>
