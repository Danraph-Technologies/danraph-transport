...
import img1 from "../assets/danraph-service18.png";
import img2 from "../assets/danraph-services19.png";
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="pt-6">
              ...
              <p className="sm:text-[32px] text-[27px] font-semibold">
                <span className="pr-[3px]">₦</span>500,000,000.00
              </p>
            </div>
            ...
            <div className="pt-4 flex gap-4 justify-center">
              <button className="group py-[6px] sm:px-7 px-5 bg-black text-white rounded-lg text-center flex items-center gap-4 border-2 border-black hover:bg-transparent hover:text-black transition duration-500 ">
                <span className="sm:text-[19px]">Withdraw</span>
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                  ...
                  <div>
                    ...
                    <p className="text-[11px] ">
                      ...
                      <span className="text-[#585858]">
                        Just sent you a fare of
                      </span>{" "}
                      <span className="font-medium">N10,000</span>{" "}
                    </p>
                  </div>
                </div>
                <div>
