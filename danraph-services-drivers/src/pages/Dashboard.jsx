    ...
    <div className="pb-6">
      <div className="sm:px-2  pb-8 flex flex-wrap items-start gap-7">
        <div className="max-w-[576px] border  border-gray-300 px-4 py-1 rounded-xl ">
          ...
          <p className="sm:text-[24px] text-[17px] font-semibold pb-2">
            Recent Earnings
          </p>
          ...
          <div className="sm:pt-8 pt-6  w-full">
            <button className="bg-[#004AAD] rounded-full w-full sm:py-2 py-1 text-white font-medium hover:bg-transparent hover:text-[#004AAD]  border-2 border-[#004AAD] transition duration-500">
              Go Offline
            </button>
            <p className="text-center mx-5 text-[12px] sm:text-[15px] py-4">
              <span className="text-[red]">Note: </span>Once you go offline,
              customer cannot see your profile and you would be unavailable
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[480px] flex-1 w-full border relative border-gray-300 rounded-xl px-4">
          <div className="absolute top-0 left-0 right-0 flex justify-between items-center bg-white px-4 py-2 z-10 rounded-t-xl">
            <span className="sm:text-[26px] text-[19px] font-semibold">
              Ride Requests
            </span>
          ...
          <div
            className="overflow-y-auto mt-10 max-h-[615px] py-5 pb-6 h-full hide-scrollbar-sm "
            ref={scrollRef}
          >
            <div></div>
            <div className="max-w-[290px] w-full border border-gray-300  px-[17px] leading-loose  rounded-xl">
              <div className="flex items-center sm:text-[18.1px] text-[15px] font-normal justify-between">
                ...
                <ImageWithSkeleton
                  src={img1}
                  alt=""
                  className="max-w-[16px] rounded-full"
                  skeletonSize={16}
                />
                <p>Hostel A</p>
              </div>

              <p className="text-[#585858] sm:text-[17.1px] text-[14px]">
                1.2 Miles
              </p>
