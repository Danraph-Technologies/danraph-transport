        ...
        <div className=''>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <div className='pt-4 flex gap-4 justify-center'>
              <button className='group py-[6px] sm:px-7 px-5 bg-black text-white rounded-lg text-center flex items-center gap-4 border-2 border-black hover:bg-transparent hover:text-black transition duration-500 '><span className='sm:text-[19px]'>Withdraw</span> 
             ...
             <div>
              <div className='flex gap-3 pb-3 justify-between items-center'>
                ...
                <img src={img1} alt="" className='max-w-[42px] w-full'/>
                  ...
                  <p className='text-[11px] '> <span className='text-[#585858]'>Just sent you a fare of</span> <span className='font-medium'>N10,000</span> </p>
