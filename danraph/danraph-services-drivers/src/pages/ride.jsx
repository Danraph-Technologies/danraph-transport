    ...
    <div>
       <div className='max-w-[500px] flex-1 w-full border relative mb-5 mt-3 border-gray-300 rounded-xl px-4 sm:mx-5'>
             <div className="absolute top-0 left-0 right-0 flex justify-between items-center bg-white px-4 py-2 z-10 rounded-t-xl">
              ...
              <div className='overflow-y-auto mt-10 mb-5 max-h-[615px]  pb-3 h-full hide-scrollbar-sm ' ref={scrollRef}>
                <div></div>
                <div className='max-w-[290px] w-full border mt-5 border-gray-300  px-[17px] leading-loose  rounded-md'>
                  ...
                  <button className='bg-[#EDEDED] border-2 border-[#EDEDED] sm:py-1 sm:px-7 px-6 hover:bg-transparent hover:border-black rounded-full text-black transition duration-500'>Decline</button>
                  </div>
