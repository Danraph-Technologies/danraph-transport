      ...
      <div className="max-w-[1100px] w-full rounded-lg border border-gray-300 py-3 px-4 mx-auto">
        <div className="flex justify-between">
          ...
          <div className="flex gap-2 items-center">
            ...
            <button className="bg-[#004AAD] hover:bg-[#004bade0] transition-all duration-300 cursor-pointer px-3 text-white py-2 rounded-lg ">
          ...
          <table className="min-w-full w-full whitespace-nowrap">
            <thead className="bg-[#004AAD]">
              <tr className="text-white text-left">
                ...
                <th className="py-2 pl-2 pr-3 w-[146px] font-normal">Date Joined</th>
