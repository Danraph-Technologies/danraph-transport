...
import img from "../assets/danraph-arrow copy.png"

const Notification = () => {
  return (
    <div className='sm:px-5'>
      <div className='max-w-[943px] w-full border border-gray-300 rounded-lg sm:px-5 px-4 py-3 '>
            <h1 className='font-semibold text-[25px] pt-3 pb-2'>Notifications</h1>
            
            <div className='max-w-[900px] w-full border border-gray-300 rounded-lg py-3 pb-5 px-3 my-4 '>
              <div className='mt-1 leading-[25px] tracking-wide '>
                <p className='flex  gap-3 justify-between '>
                <span className='sm:text-[20.33px] text-[18px] font-medium text-[#231F20] '>A ride has been booked</span>
                <span className='text-[#231F20]'>12/01/2022-5:33pm</span>
               </p>
      
              <div className='flex flex-wrap gap-2  items-center border-b pt-2 pb-3 rounded-b-lg border-gray-300'>
                <p className='sm:text-[20.33px] text-[18px]'>A ride has been booked from </p>
                <div className='flex flex-wrap items-center gap-2 sm:px-2'>
                  <p className='sm:text-[19.22px] text-[17px] font-[500] '>
                  Main Gate
                </p>
                <p><img src={img} alt="" className='max-w-[16.82px] w-full' /></p>
                <p className='sm:text-[19.22px] text-[17px] font-[500] '>Hostel A</p>
                </div>
                
      
                <p className='sm:text-[20.33px] text-[18px]'>click <span className='text-blue-700 cursor-pointer hover:underline'>here</span> to view user  contact details</p>
              </div>
              </div>
             
      
             <div className='mt-4 leading-[25px] tracking-wide '>
                <p className='flex justify-between'>
                <span className='sm:text-[20.33px] text-[18px] font-medium text-[#231F20] '>New user registered.</span>
                <span className='text-[#231F20]'>12/01/2022-5:33pm</span>
              </p>
      
              <div className='flex flex-wrap gap-2 items-center border-b pt-2 pb-3 rounded-b-lg border-gray-300'>
                <p className='sm:text-[20.33px] text-[18px]'>A new user with email address; jane3@email.com just registered </p>
              </div>
              </div>
