       ...
       <table className="min-w-max whitespace-nowrap">
          <thead className='bg-[#004AAD]'>
                <tr className='text-white text-left'>
                  <th className='py-2 pl-3 pr-3 w-[146px] font-normal'>Full Name</th>
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>User Type</th>
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>Student/Staff ID</th>
                  ...
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>Wallet Balance</th>
            ...
            <tbody>
              <tr className='border-b '>
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'>Grace Joe</td>
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'>Student</td>
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'>127663377</td>
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'>09168071385</td>
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'>gracejoe@email.com</td>
                ...
                <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-10'> ₦ 5,000</td>
