...
const Trips = () => {
  return (
    <div className='sm:px-5'>
      <div className='w-full flex flex-col sm:justify-start justify-center border border-gray-300 rounded-lg py-2 px-4'>
        <div>
            ...
            <table className='min-w-full whitespace-nowrap'>
              <thead className='bg-[#004AAD]'>
                <tr className='text-white text-left'>
                  ...
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>Fare Collected Status</th>
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>Trip Status</th>
                  <th className='py-2 pl-2 pr-3 w-[146px] font-normal'>Driver Name/ID USername/ID</th>
        ...
        <div className=' shadow-md shadow-gray-300 mx-auto w-full border border-gray-300 rounded-lg  py-2  my-4 '>
          <p className='text-[19px] font-medium px-4 py-1'>Payments History</p>
