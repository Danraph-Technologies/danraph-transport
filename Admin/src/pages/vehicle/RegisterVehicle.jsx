    ...
    <div>
      <div>
        <div className="flex items-center gap-2 pb-5">
          ...
          <span className="text-[22px] font-semibold ">Register Vehicle</span>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6">
              <div className="flex flex-col gap-4 items-center">
                ...
                <p className="underline cursor-pointer">View Vehicle licence</p>
            ...
            <div className="py-2">
              <div className="py-5">
                <h2 className="text-[19px] font-semibold">Assign Driver</h2>
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="">Choose Driver</label>
                <select
                  name=""
                  id=""
