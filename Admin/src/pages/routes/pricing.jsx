                        ...
                        <table className='min-w-full whitespace-nowrap'>
                            <thead className='bg-[#004AAD]'>
                                <tr className='text-white text-left'>
                                    ...
                                    <th className='py-2 pl-2 pr-3  font-normal'>Total Trips Completed</th>
                                    <th className='py-2 pl-2 pr-3  font-normal'>Total Fare Collected (₦)</th>
                                    <th className='py-2 pl-2 pr-3  font-normal'>Commission Deducted (₦)</th>
                                    <th className='py-2 pl-2 pr-3  font-normal'>Net Payout to Driver</th>
                                    <th className='py-2 pl-2 pr-3  font-normal'>Payment Status</th>
                                    <th className='py-2 pl-2 pr-3  font-normal'>Last Payment Date</th>
                            ...
                            <tbody>
                                <tr className='border-b '>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>James Okeke</td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>30</td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>5,000</td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>1,000</td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>4,000</td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'> <span className='rounded-full w-[12px] h-[12px] bg-[#F80B0B] inline-block'></span>  <span>Pending</span> </td>
                                    <td className='whitespace-nowrap border-r border-[#dbdbdb7e] py-4 pl-3 pr-3'>4/4/2025</td>
