        ...
        >
          ...
          <section aria-labelledby="book-ride-heading">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              >
                <button className="bg-blue-800 border-2 w-full border-blue-800 m-5 md:py-2 py-1 text-[20px] hover:bg-transparent hover:text-blue-800 transition duration-500 rounded-full text-white">
                  Charter a Car
                </button>
              </Link>
            </div>
