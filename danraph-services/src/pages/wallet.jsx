...
const wallet = () => {
  // Remove backend integration, use static balance
  ...
  return (
    <div className="flex justify-center lg:justify-start lg:pb-5 pb-14 lg:px-4  ">
      <div className="max-w-[389px] w-full border pb-3 border-gray-300 rounded-md ">
        <div className="">
          <p className="sm:text-[26px] text-[20px] font-semibold px-5 pt-6">
            Wallet
          </p>
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="pt-6 flex gap-4 justify-center">
              <button className="group py-[6px] sm:px-7 px-5 bg-black text-white rounded-lg text-center flex items-center gap-4 border-2 border-black hover:bg-transparent hover:text-black transition duration-500 ">
                <span className="sm:text-[19px]">Send</span>
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                ...
                >
                  <path
                    ...
                    fill="white"
                    className="transition-colors duration-500 group-hover:fill-black"
                  />
                </svg>
              </button>
              ...
              <button className="group py-[6px] sm:px-7 px-5 bg-black text-white rounded-lg text-center flex items-center gap-4 border-2 border-black hover:bg-transparent hover:text-black transition duration-500 ">
                ...
                >
                  <path
                    d="M18.5306 6.53055L7.81031 17.2499H15.75C15.9489 17.2499 16.1397 17.3289 16.2803 17.4696C16.421 17.6103 16.5 17.801 16.5 17.9999C16.5 18.1988 16.421 18.3896 16.2803 18.5303C16.1397 18.6709 15.9489 18.7499 15.75 18.7499H6C5.80109 18.7499 5.61032 18.6709 5.46967 18.5303C5.32902 18.3896 5.25 18.1988 5.25 17.9999V8.24993C5.25 8.05102 5.32902 7.86025 5.46967 7.7196C5.61032 7.57895 5.80109 7.49993 6 7.49993C6.19891 7.49993 6.38968 7.57895 6.53033 7.7196C6.67098 7.86025 6.75 8.05102 6.75 8.24993V16.1896L17.4694 5.4693C17.5391 5.39962 17.6218 5.34435 17.7128 5.30663C17.8039 5.26892 17.9015 5.24951 18 5.24951C18.0985 5.24951 18.1961 5.26892 18.2872 5.30663C18.3782 5.34435 18.4609 5.39962 18.5306 5.4693C18.6003"
                    fill="white"
                    className="transition-colors duration-500 group-hover:fill-black 5.53899 18.6556 5.62171 18.6933 5.71276C18.731 5.8038 18.7504 5.90138 18.7504 5.99993C18.7504 6.09847 18.731 6.19606 18.6933 6.2871C18.6556 6.37815 18.6003 6.46087 18.5306 6.53055Z"
                  />
                </svg>
              </button>
            </div>
            ...
            <div className="pt-6">
              <p className="flex gap-2 py-2">
                <span className="sm:text-[17px] text-[14px]">
                  User ID: 234467892{" "}
                </span>
                <svg
          ...
          <div className="px-4 ">
            <p className=" py-2 pb-5 sm:text-[16px] text-[13px]">
              Quick transfer
            </p>
            <div className="flex flex-wrap sm:gap-[10px] gap-1 med:gap-2 pb-2 justify-center items-center">
              <ImageWithSkeleton
                src={img1}
                alt=""
                className="sm:max-w-[42px] med:max-w-[36px] max-w-[32px] w-full cursor-pointer"
                skeletonSize={42}
              />
              <ImageWithSkeleton
                src={img2}
              ...
              <div className="flex gap-3 pb-3 justify-between items-center">
                <div className="flex gap-2 items-center  ">
                  <ImageWithSkeleton
                    src={img1}
                    alt=""
                    className="max-w-[42px] w-full"
                    skeletonSize={42}
                  />
                  <div>
                    <p className="text-[13px] text-[#231F20]">Dandave</p>
                    <p className="text-[11px] text-[#585858]">
                      Just sent you N10,000
                    </p>
                  </div>
                </div>
                <div>
                  {" "}
                  <p className="text-[11px]">Just now</p>
                </div>
              </div>
              <hr className="py-2" />
