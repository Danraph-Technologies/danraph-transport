  ...
  return (
    <div className='border-b-[1px] bg-[#FFFFFF] border-gray-300 pb-3 fixed top-0 left-0 w-full z-50'>
      <div className='items-center hidden nav:flex justify-between mx-5'>
            ...
            <Link to="/"><img src={img1} alt="" className='max-w-[170px] w-full'/></Link>
                <div className="relative max-w-[582px] w-[450px] top-4 "> 
                    <input type="text" placeholder="Search..."  className="pl-10 pr-4 py-2 border border-gray-400 rounded-3xl w-full outline-none" />
            ...
            <div className='flex items-center gap-4 translate-y-4'>
               ...
               <div>
              <Link to="/users/settings"><img src={img2} alt="" className='rounded-full w-[42px] h-[42px] cursor-pointer ' />  </Link> 
               </div>
            </div>
        ...
        <Link to="/"><img src={img1} alt="" className='max-w-[130px] w-full'/></Link>
        <Link to="/users/settings"><img src={img2} alt="" className='rounded-full w-[42px] h-[42px] cursor-pointer' /></Link>
      </div>
    </div>
  );
