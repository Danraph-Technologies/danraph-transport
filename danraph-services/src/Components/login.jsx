    ...
    <div className='max-w-[100%] flex justify-center  log:items-center '>
      <div className=' flex-1 relative hidden lg:block'>
       ...
       <div style={{ backgroundColor: '#F6F9F6' }} className='  flex-1 w-full pb-5 '>
        ...
        <p className=''><Link to="/" className='inline-block'><FaArrowLeft/></Link>  </p>
        <p className=' hidden sm:block'>Dont't have an account? <Link to="/signup"><span className=' font-medium underline cursor-pointer'>Sign up</span></Link></p>
